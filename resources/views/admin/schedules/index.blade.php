...
<div class="container mb-4">
    ...
    <table class="table table-bordered">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>{{ $schedule->route->originTerminal->name }} - {{ $schedule->route->destinationTerminal->name }}</td>
                <td>{{ \Carbon\Carbon::parse($schedule->departure_time)->format('Y-m-d H:i') }}</td>
                <td>{{ $schedule->total_seats }}</td>
                <td>
                    <!-- Edit Button -->
                    <button type="button" class="btn btn-warning" data-bs-toggle="modal" data-bs-target="#editScheduleModal"
                            data-id="{{ $schedule->id }}"
    ...
    <!-- Add Schedule Modal -->
    <div class="modal fade" id="modalScheduleForm" tabindex="-1" aria-labelledby="modalScheduleFormLabel" aria-hidden="true">
            ...
            <div class="modal-content rounded-4 shadow">
                ...
                <div class="modal-body p-5 pt-0">
                    <form action="{{ route('schedules.store') }}" method="POST">
                        ...
                        <div class="form-floating mb-3">
                            <input type="time" class="form-control rounded-3" id="departure_time" name="departure_time" required>
                            <label for="departure_time">Departure Time</label>
                        </div>

                        <!-- Total Seats Field -->
                        <div class="form-floating mb-3">
                            <input type="number" class="form-control rounded-3" id="total_seats" name="total_seats" required min="1">
            ...
            <div class="modal-content rounded-4 shadow">
                ...
                <div class="modal-body p-5 pt-0">
                    <form id="editScheduleForm" method="POST">
                        ...
                        <!-- Departure Time Field -->
                        <div class="form-floating mb-3">
                            <input type="datetime-local" class="form-control rounded-3" id="editDepartureTime" name="departure_time">
                            <label for="editDepartureTime">Departure Time</label>
                        </div>

                        <!-- Total Seats Field -->
                        <div class="form-floating mb-3">
                            <input type="number" class="form-control rounded-3" id="editTotalSeats" name="total_seats">
                            <label for="editTotalSeats">Total Seats</label>
                        </div>

                        <!-- Submit Button -->
                        <button class="w-100 mb-2 btn btn-lg rounded-3 btn-primary" type="submit">Update Schedule</button>
                    </form>
                </div>
            </div>
        </div>
