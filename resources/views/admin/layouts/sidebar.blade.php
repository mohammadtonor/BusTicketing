<div class="d-flex flex-column flex-shrink-0 p-3 text-bg-dark d-none d-lg-block" style="width: 280px;">
  ...
  <div class="d-flex flex-column flex-shrink-0 b d-lg-none d-sm-block d-md-block" style="width: 4.5rem;">
    ...
    <ul class="nav nav-pills nav-flush flex-column mb-auto text-center">
      ...
      <li>
        <a href="{{route('buses.index')}}" class="nav-link py-3 border-bottom rounded-0" data-bs-toggle="tooltip" data-bs-placement="right" aria-label="Orders" data-bs-original-title="Buses">
          <svg class="bi pe-none" width="24" height="24" role="img" aria-label="Buses"><use xlink:href="#table"></use></svg>
        </a>
      </li>
      <li>
        <a href="{{route('cities.index')}}" class="nav-link py-3 border-bottom rounded-0" data-bs-toggle="tooltip" data-bs-placement="right" aria-label="Products" data-bs-original-title="Cities">
          <svg class="bi pe-none" width="24" height="24" role="img" aria-label="Cities"><use xlink:href="#grid"></use></svg>
        </a>
      </li>
      <li>
        <a href="{{route('terminals.index')}}" class="nav-link py-3 border-bottom rounded-0" data-bs-toggle="tooltip" data-bs-placement="right" aria-label="Terminals" data-bs-original-title="Terminals">
          <svg class="bi pe-none" width="24" height="24" role="img" aria-label="Terminals"><use xlink:href="#people-circle"></use></svg>
        </a>
      </li>
    </ul>
